  ...
  var Dropdown = function (_Component2) {
    ...
    _createClass(Dropdown, [{
      ...
      value: function _getDropdownPosition() {
        var offsetParentBRect = document.getElementById("encboundingcontainer").getBoundingClientRect(); //this.el.offsetParent.getBoundingClientRect(); CHANGED 4-18-18
        ...
        //dropdownBounds = document.getElementById("encboundingcontainer").getBoundingClientRect();

        // Countainer here will be closest ancestor with overflow: hidden
        var closestOverflowParent = document.getElementById("encboundingcontainer"); //this.dropdownEl.offsetParent; CHANGED 4-18-18
        ...
        //if (!alignments.top) {   // REMOVED 4-18-18
          if (alignments.bottom) {
            ...
            if ( false && alignments.spaceOnTop > alignments.spaceOnBottom) {    // ADDED 4-18-18
              verticalAlignment = 'bottom';
        ...
        return {
          ...
          height: ( idealHeight > 200 ? 200 : idealHeight ), //idealHeight, // ADDED 4-18-2018
          width: idealWidth
        };
      }
      ...
      value: function _placeDropdown() {
        ...
        //this.dropdownEl.style.zIndex = "700";
...
;(function ($) {
  ...
  M.textareaAutoResize = function ($textarea) {
    ...
    var hiddenDiv = $('#myhiddendiv').first();
    if (!hiddenDiv.length) {
      hiddenDiv = $('<div class="hiddendiv common"></div>');
      $('#myhiddendiv').append(hiddenDiv);
    }
